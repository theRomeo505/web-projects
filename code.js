$(document).ready(function () {
    ...
    function getJoke(json, side) {
        ...
        if (side === "l") {
            if (json.categories.length != 0) {
                $(joke).html("<div class='joke col-sm-10 align-self-center'><img src='Vector.svg' alt='' class='iconlikeactive i1'> <img src='heart.svg' alt='' class='iconlikeactive' hidden>                        <div class='row'>                            <div class='row-l col-2'>                                <div class='iconwrap'>                                    <img src='message.svg' alt='' class='icon'></div>            </div>                            <div class='row-r col-9'>                                <p class='id'>ID: <a href='" + json.url + "' class='jokehref'>" + json.id + "</a>                                </p>                                <p class='joketxt'>" + json.value + "</p>                                <p class='jokedate'>" + "updated last: " + Math.floor(date) + " hours ago" + "</p>                                <p class='jokecat'>" + json.categories + "</p>                            </div>                        </div>                    </div>");
            } else {
                $(joke).html("<div class='joke col-sm-10 align-self-center'><img src='Vector.svg' alt='' class='iconlikeactive i1'> <img src='heart.svg' alt='' class='iconlikeactive' hidden>                        <div class='row'>                            <div class='row-l col-2'>                                <div class='iconwrap'>                                    <img src='message.svg' alt='' class='icon'></div>            </div>                            <div class='row-r col-9'>                                <p class='id'>ID: <a href='" + json.url + "' class='jokehref'>" + json.id + "</a>                                </p>                                <p class='joketxt'>" + json.value + "</p>                                <p class='jokedate'>" + "updated last: " + Math.floor(date) + " hours ago" + "</p>                                                            </div>                        </div>                    </div>");
            }
        } else {
            if (json.categories.length != 0) {
                $(joke).html("<div class='joke col-sm-10 align-self-center'><img src='Vector.svg' alt='' class='iconlikeactive i1' hidden> <img src='heart.svg' alt='' class='iconlikeactive'>                        <div class='row'>                            <div class='row-l col-2'>                                <div class='iconwrap'>                                    <img src='message.svg' alt='' class='icon'></div>            </div>                            <div class='row-r col-9'>                                <p class='id'>ID: <a href='" + json.url + "' class='jokehref'>" + json.id + "</a>                                </p>                                <p class='joketxt'>" + json.value + "</p>                                <p class='jokedate'>" + "updated last: " + Math.floor(date) + " hours ago" + "</p>                                <p class='jokecat'>" + json.categories + "</p>                            </div>                        </div>                    </div>");
            } else {
                $(joke).html("<div class='joke col-sm-10 align-self-center'><img src='Vector.svg' alt='' class='iconlikeactive i1' hidden> <img src='heart.svg' alt='' class='iconlikeactive' >                        <div class='row'>                            <div class='row-l col-2'>                                <div class='iconwrap'>                                    <img src='message.svg' alt='' class='icon'></div>            </div>                            <div class='row-r col-9'>                                <p class='id'>ID: <a href='" + json.url + "' class='jokehref'>" + json.id + "</a>                                </p>                                <p class='joketxt'>" + json.value + "</p>                                <p class='jokedate'>" + "updated last: " + Math.floor(date) + " hours ago" + "</p>                                                            </div>                        </div>                    </div>");
            }
                ...
                if (liked[i] === $(this).parent().find("a").attr("href")) {
                    ...
                    for (let i = 0; i < a.length; i++) {
                        ...
                        if ($(a[i]).attr("href") === $(this).parent().find("a").attr("href")) {
                           ...
                           console.log($(a[i]).parent().parent().parent().parent().find("img").first()); $(a[i]).parent().parent().parent().parent().find("img").first().removeAttr("hidden");
                    ...
                    liked.splice(i, 1);
                    $('.right').children().get(i+1).remove();break;
                }
            }
          //  renderR();
        }
    ...
    $('.favouritebutton').click(function(){
        ...
        setTimeout(function(){$('.right').toggleClass("rop")},10);
    ...
    $('.right-hover').click(function(){
      //  $(".right").toggleClass("disabledr");
        
$(".right").toggleClass("ractive");
        setTimeout(function(){$('.right').toggleClass("rop")},10);        $('.favouritebtn').toggleClass('disabled');
        $('.right-hover').toggleClass("disabled");
    })
